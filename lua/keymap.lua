...
vim.keymap.set("n", "<leader>gi", "<cmd>Trouble lsp_implementations toggle auto_refresh=false auto_preview=false<cr>",
    { desc = "Go to implementsion" })
vim.keymap.set("n", "<leader>gd", "<cmd>Trouble lsp_definitions toggle auto_refresh=false auto_preview=false<cr>",
    { desc = "Go to definitions" })
vim.keymap.set("n", "<leader>gt", "<cmd>Trouble lsp_type_definitions toggle auto_refresh=false auto_preview=false<cr>",
    { desc = "Go to type definitions" })


vim.keymap.set("n", "<leader>dg",
    "<cmd>Trouble diagnostics toggle filter.buf=0 auto_refresh=false auto_preview=false<cr>",
...
vim.keymap.set({"i", "s"}, "<TAB>", functions.lua_snip_jump_expand_or_tab, {silent = true})
